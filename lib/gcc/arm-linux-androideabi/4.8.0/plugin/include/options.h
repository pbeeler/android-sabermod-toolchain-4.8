...
enum opt_code
{
  ...
  OPT_mandroid = 1037,                       /* -mandroid */
  OPT_mapcs = 1038,                          /* -mapcs */
  OPT_mapcs_float = 1039,                    /* -mapcs-float */
  OPT_mapcs_frame = 1040,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1041,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1042,              /* -mapcs-stack-check */
  OPT_march_ = 1043,                         /* -march= */
  OPT_marm = 1044,                           /* -marm */
  OPT_mbig_endian = 1045,                    /* -mbig-endian */
  OPT_mbionic = 1046,                        /* -mbionic */
  ...
  OPT_profile = 1106,                        /* -profile */
  OPT_pthread = 1107,                        /* -pthread */
  OPT_quiet = 1108,                          /* -quiet */
  OPT_r = 1109,                              /* -r */
  OPT_rdynamic = 1110,                       /* -rdynamic */
