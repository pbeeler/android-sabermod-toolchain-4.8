...
enum opt_code
{
  ...
  OPT_fextern_tls_init = 582,                /* -fextern-tls-init */
  OPT_fexternal_blas = 583,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 584, */       /* -fexternal-templates */
  OPT_ff2c = 585,                            /* -ff2c */
  OPT_ffast_math = 586,                      /* -ffast-math */
  OPT_ffat_lto_objects = 587,                /* -ffat-lto-objects */
  OPT_ffilelist_file = 588,                  /* -ffilelist-file */
  OPT_ffinite_math_only = 589,               /* -ffinite-math-only */
  OPT_ffixed_ = 590,                         /* -ffixed- */
  OPT_ffixed_form = 591,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 592,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 593,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 594,                    /* -ffloat-store */
  OPT_ffor_scope = 595,                      /* -ffor-scope */
  /* OPT_fforce_addr = 596, */               /* -fforce-addr */
  OPT_fforce_classes_archive_check = 597,    /* -fforce-classes-archive-check */
  OPT_fforward_propagate = 598,              /* -fforward-propagate */
  OPT_ffp_contract_ = 599,                   /* -ffp-contract= */
  OPT_ffpe_trap_ = 600,                      /* -ffpe-trap= */
  OPT_ffree_form = 601,                      /* -ffree-form */
  OPT_ffree_line_length_ = 602,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 603,          /* -ffree-line-length-none */
  OPT_ffreestanding = 604,                   /* -ffreestanding */
  OPT_ffriend_injection = 605,               /* -ffriend-injection */
  OPT_ffrontend_optimize = 606,              /* -ffrontend-optimize */
  ...
  OPT_fgnu_tm = 616,                         /* -fgnu-tm */
  OPT_fgnu89_inline = 617,                   /* -fgnu89-inline */
  OPT_fgo_check_divide_overflow = 618,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 619,           /* -fgo-check-divide-zero */
  OPT_fgo_dump_ = 620,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 621,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 622,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 623,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 624,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 625,                       /* -fgraphite */
  OPT_fgraphite_identity = 626,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 627,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 628, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 629, */        /* -fhandle-exceptions */
  OPT_fhash_synchronization = 630,           /* -fhash-synchronization */
  /* OPT_fhelp = 631, */                     /* -fhelp */
  /* OPT_fhelp_ = 632, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 633,           /* -fhoist-adjacent-loads */
  /* OPT_fhonor_std = 634, */                /* -fhonor-std */
  OPT_fhosted = 635,                         /* -fhosted */
  /* OPT_fhuge_objects = 636, */             /* -fhuge-objects */
  OPT_fident = 637,                          /* -fident */
  OPT_fif_conversion = 638,                  /* -fif-conversion */
  OPT_fif_conversion2 = 639,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 640,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 641,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 642,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 643,             /* -fimplicit-templates */
  OPT_findirect_classes = 644,               /* -findirect-classes */
  OPT_findirect_dispatch = 645,              /* -findirect-dispatch */
  OPT_findirect_inlining = 646,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 647,         /* -finhibit-size-directive */
  OPT_finit_character_ = 648,                /* -finit-character= */
  OPT_finit_integer_ = 649,                  /* -finit-integer= */
  OPT_finit_local_zero = 650,                /* -finit-local-zero */
  OPT_finit_logical_ = 651,                  /* -finit-logical= */
  OPT_finit_real_ = 652,                     /* -finit-real= */
  OPT_finline = 653,                         /* -finline */
  OPT_finline_atomics = 654,                 /* -finline-atomics */
  OPT_finline_functions = 655,               /* -finline-functions */
  OPT_finline_functions_called_once = 656,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 657, */            /* -finline-limit- */
  OPT_finline_limit_ = 658,                  /* -finline-limit= */
  OPT_finline_small_functions = 659,         /* -finline-small-functions */
  OPT_finput_charset_ = 660,                 /* -finput-charset= */
  OPT_finstrument_functions = 661,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 662,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 663,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 664,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 665,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 666,        /* -fintrinsic-modules-path= */
  OPT_fipa_cp = 667,                         /* -fipa-cp */
  OPT_fipa_cp_clone = 668,                   /* -fipa-cp-clone */
  /* OPT_fipa_matrix_reorg = 669, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 670,                    /* -fipa-profile */
  OPT_fipa_pta = 671,                        /* -fipa-pta */
  OPT_fipa_pure_const = 672,                 /* -fipa-pure-const */
  OPT_fipa_reference = 673,                  /* -fipa-reference */
  OPT_fipa_sra = 674,                        /* -fipa-sra */
  /* OPT_fipa_struct_reorg = 675, */         /* -fipa-struct-reorg */
  OPT_fira_algorithm_ = 676,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 677,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 678,              /* -fira-loop-pressure */
  OPT_fira_region_ = 679,                    /* -fira-region= */
  OPT_fira_share_save_slots = 680,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 681,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 682,                   /* -fira-verbose= */
  OPT_fivopts = 683,                         /* -fivopts */
  OPT_fjni = 684,                            /* -fjni */
  OPT_fjump_tables = 685,                    /* -fjump-tables */
  OPT_fkeep_inline_dllexport = 686,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 687,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 688,             /* -fkeep-static-consts */
  /* OPT_flabels_ok = 689, */                /* -flabels-ok */
  OPT_flax_vector_conversions = 690,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 691,             /* -fleading-underscore */
  OPT_floop_block = 692,                     /* -floop-block */
  /* OPT_floop_flatten = 693, */             /* -floop-flatten */
  OPT_floop_interchange = 694,               /* -floop-interchange */
  OPT_floop_nest_optimize = 695,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 696, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 697,           /* -floop-parallelize-all */
  OPT_floop_strip_mine = 698,                /* -floop-strip-mine */
  OPT_flto = 699,                            /* -flto */
  OPT_flto_compression_level_ = 700,         /* -flto-compression-level= */
  OPT_flto_partition_1to1 = 701,             /* -flto-partition=1to1 */
  OPT_flto_partition_balanced = 702,         /* -flto-partition=balanced */
  OPT_flto_partition_max = 703,              /* -flto-partition=max */
  OPT_flto_partition_none = 704,             /* -flto-partition=none */
  OPT_flto_report = 705,                     /* -flto-report */
  OPT_flto_ = 706,                           /* -flto= */
  OPT_fltrans = 707,                         /* -fltrans */
  OPT_fltrans_output_list_ = 708,            /* -fltrans-output-list= */
  OPT_fmain_ = 709,                          /* -fmain= */
  OPT_fmath_errno = 710,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 711,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 712,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 713,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 714,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 715,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 716,                     /* -fmem-report */
  OPT_fmem_report_wpa = 717,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 718,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 719,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 720,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 721,                /* -fmessage-length= */
  OPT_fmodule_private = 722,                 /* -fmodule-private */
  OPT_fmodulo_sched = 723,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 724,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 725,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 726,                  /* -fms-extensions */
  OPT_fmudflap = 727,                        /* -fmudflap */
  OPT_fmudflapir = 728,                      /* -fmudflapir */
  OPT_fmudflapth = 729,                      /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 730, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 731, */                  /* -fnew-abi */
  OPT_fnext_runtime = 732,                   /* -fnext-runtime */
  OPT_fnil_receivers = 733,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 734,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 735,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 736, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 737,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 738,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 739,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 740,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 741,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 742,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 743,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 744,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 745,                 /* -fobjc-std=objc1 */
  OPT_fomit_frame_pointer = 746,             /* -fomit-frame-pointer */
  OPT_fopenmp = 747,                         /* -fopenmp */
  OPT_foperator_names = 748,                 /* -foperator-names */
  OPT_fopt_info = 749,                       /* -fopt-info */
  OPT_fopt_info_ = 750,                      /* -fopt-info- */
  OPT_foptimize_register_move = 751,         /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 752,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 753,/* -foptimize-static-class-initialization */
  OPT_foptimize_strlen = 754,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 755, */           /* -foptional-diags */
  OPT_foutput_class_dir_ = 756,              /* -foutput-class-dir= */
  OPT_fpack_derived = 757,                   /* -fpack-derived */
  OPT_fpack_struct = 758,                    /* -fpack-struct */
  OPT_fpack_struct_ = 759,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 760,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 761,              /* -fpcc-struct-return */
  OPT_fpch_deps = 762,                       /* -fpch-deps */
  OPT_fpch_preprocess = 763,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 764,                     /* -fpeel-loops */
  OPT_fpeephole = 765,                       /* -fpeephole */
  OPT_fpeephole2 = 766,                      /* -fpeephole2 */
  OPT_fpermissive = 767,                     /* -fpermissive */
  OPT_fpic = 768,                            /* -fpic */
  OPT_fpie = 769,                            /* -fpie */
  OPT_fplan9_extensions = 770,               /* -fplan9-extensions */
  OPT_fplugin_arg_ = 771,                    /* -fplugin-arg- */
  OPT_fplugin_ = 772,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 773,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 774,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 775,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 776,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 777,                   /* -fpreprocessed */
  OPT_fpretty_templates = 778,               /* -fpretty-templates */
  OPT_fprofile = 779,                        /* -fprofile */
  OPT_fprofile_arcs = 780,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 781,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 782,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 783,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 784,              /* -fprofile-generate= */
  OPT_fprofile_report = 785,                 /* -fprofile-report */
  OPT_fprofile_use = 786,                    /* -fprofile-use */
  OPT_fprofile_use_ = 787,                   /* -fprofile-use= */
  OPT_fprofile_values = 788,                 /* -fprofile-values */
  OPT_fprotect_parens = 789,                 /* -fprotect-parens */
  OPT_frandom_seed = 790,                    /* -frandom-seed */
  OPT_frandom_seed_ = 791,                   /* -frandom-seed= */
  OPT_frange_check = 792,                    /* -frange-check */
  OPT_freal_4_real_10 = 793,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 794,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 795,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 796,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 797,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 798,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 799,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 800,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 801,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 802,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 803,                /* -frecord-marker=8 */
  OPT_frecursive = 804,                      /* -frecursive */
  OPT_freduced_reflection = 805,             /* -freduced-reflection */
  OPT_free = 806,                            /* -free */
  OPT_freg_struct_return = 807,              /* -freg-struct-return */
  OPT_fregmove = 808,                        /* -fregmove */
  OPT_frename_registers = 809,               /* -frename-registers */
  OPT_freorder_blocks = 810,                 /* -freorder-blocks */
  OPT_freorder_blocks_and_partition = 811,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 812,              /* -freorder-functions */
  OPT_frepack_arrays = 813,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 814,           /* -freplace-objc-classes */
  OPT_frepo = 815,                           /* -frepo */
  OPT_frequire_return_statement = 816,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 817,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 818, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 819,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 820,                    /* -fresolution= */
  OPT_frounding_math = 821,                  /* -frounding-math */
  OPT_frtti = 822,                           /* -frtti */
  OPT_fsanitize_address = 823,               /* -fsanitize=address */
  OPT_fsanitize_thread = 824,                /* -fsanitize=thread */
  OPT_fsaw_java_file = 825,                  /* -fsaw-java-file */
  OPT_fsched_critical_path_heuristic = 826,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 827,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 828,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 829,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 830,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 831,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 832,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 833,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 834,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 835,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 836,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 837,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 838,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 839,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 840,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 841,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 842,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 843, */        /* -fsched2-use-traces */
  OPT_fschedule_insns = 844,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 845,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 846,              /* -fsecond-underscore */
  OPT_fsection_anchors = 847,                /* -fsection-anchors */
  /* OPT_fsee = 848, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 849,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 850,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 851, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 852,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 853,          /* -fselective-scheduling2 */
  OPT_fshort_double = 854,                   /* -fshort-double */
  OPT_fshort_enums = 855,                    /* -fshort-enums */
  OPT_fshort_wchar = 856,                    /* -fshort-wchar */
  OPT_fshow_column = 857,                    /* -fshow-column */
  OPT_fshrink_wrap = 858,                    /* -fshrink-wrap */
  OPT_fsign_zero = 859,                      /* -fsign-zero */
  OPT_fsignaling_nans = 860,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 861,               /* -fsigned-bitfields */
  OPT_fsigned_char = 862,                    /* -fsigned-char */
  OPT_fsigned_zeros = 863,                   /* -fsigned-zeros */
  OPT_fsingle_precision_constant = 864,      /* -fsingle-precision-constant */
  OPT_fsource_filename_ = 865,               /* -fsource-filename= */
  OPT_fsource_ = 866,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 867,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 868,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 869,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 870, */                 /* -fsquangle */
  OPT_fstack_arrays = 871,                   /* -fstack-arrays */
  /* OPT_fstack_check = 872, */              /* -fstack-check */
  OPT_fstack_check_ = 873,                   /* -fstack-check= */
  OPT_fstack_limit = 874,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 875,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 876,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 877,                /* -fstack-protector */
  OPT_fstack_protector_all = 878,            /* -fstack-protector-all */
  OPT_fstack_reuse_ = 879,                   /* -fstack-reuse= */
  OPT_fstack_usage = 880,                    /* -fstack-usage */
  OPT_fstats = 881,                          /* -fstats */
  OPT_fstore_check = 882,                    /* -fstore-check */
  /* OPT_fstrength_reduce = 883, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 884,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 885,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 886,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 887, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 888,      /* -fstrict-volatile-bitfields */
  OPT_fsync_libcalls = 889,                  /* -fsync-libcalls */
  OPT_fsyntax_only = 890,                    /* -fsyntax-only */
  OPT_ftabstop_ = 891,                       /* -ftabstop= */
  /* OPT_ftarget_help = 892, */              /* -ftarget-help */
  OPT_ftarget_ = 893,                        /* -ftarget= */
  OPT_ftemplate_backtrace_limit_ = 894,      /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 895, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 896,                /* -ftemplate-depth= */
  OPT_ftest_coverage = 897,                  /* -ftest-coverage */
  /* OPT_fthis_is_variable = 898, */         /* -fthis-is-variable */
  OPT_fthread_jumps = 899,                   /* -fthread-jumps */
  OPT_fthreadsafe_statics = 900,             /* -fthreadsafe-statics */
  OPT_ftime_report = 901,                    /* -ftime-report */
  OPT_ftls_model_ = 902,                     /* -ftls-model= */
  OPT_ftoplevel_reorder = 903,               /* -ftoplevel-reorder */
  OPT_ftracer = 904,                         /* -ftracer */
  OPT_ftrack_macro_expansion = 905,          /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 906,         /* -ftrack-macro-expansion= */
  OPT_ftrapping_math = 907,                  /* -ftrapping-math */
  OPT_ftrapv = 908,                          /* -ftrapv */
  OPT_ftree_bit_ccp = 909,                   /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 910,          /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 911,                       /* -ftree-ccp */
  OPT_ftree_ch = 912,                        /* -ftree-ch */
  OPT_ftree_coalesce_inlined_vars = 913,     /* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 914,             /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 915,                 /* -ftree-copy-prop */
  OPT_ftree_copyrename = 916,                /* -ftree-copyrename */
  OPT_ftree_cselim = 917,                    /* -ftree-cselim */
  OPT_ftree_dce = 918,                       /* -ftree-dce */
  OPT_ftree_dominator_opts = 919,            /* -ftree-dominator-opts */
  OPT_ftree_dse = 920,                       /* -ftree-dse */
  OPT_ftree_forwprop = 921,                  /* -ftree-forwprop */
  OPT_ftree_fre = 922,                       /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 923,  /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 924,         /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 925,           /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 926,    /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 927,                   /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 928,              /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 929, */         /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 930,             /* -ftree-loop-optimize */
  OPT_ftree_lrs = 931,                       /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 932,        /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 933,               /* -ftree-partial-pre */
  OPT_ftree_phiprop = 934,                   /* -ftree-phiprop */
  OPT_ftree_pre = 935,                       /* -ftree-pre */
  OPT_ftree_pta = 936,                       /* -ftree-pta */
  OPT_ftree_reassoc = 937,                   /* -ftree-reassoc */
  /* OPT_ftree_salias = 938, */              /* -ftree-salias */
  OPT_ftree_scev_cprop = 939,                /* -ftree-scev-cprop */
  OPT_ftree_sink = 940,                      /* -ftree-sink */
  OPT_ftree_slp_vectorize = 941,             /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 942,                      /* -ftree-slsr */
  OPT_ftree_sra = 943,                       /* -ftree-sra */
  /* OPT_ftree_store_ccp = 944, */           /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 945, */     /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 946,         /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 947,                /* -ftree-tail-merge */
  OPT_ftree_ter = 948,                       /* -ftree-ter */
  OPT_ftree_vect_loop_version = 949,         /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 950,                 /* -ftree-vectorize */
  OPT_ftree_vectorizer_verbose_ = 951,       /* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 952,                       /* -ftree-vrp */
  OPT_funderscoring = 953,                   /* -funderscoring */
  OPT_funit_at_a_time = 954,                 /* -funit-at-a-time */
  OPT_funroll_all_loops = 955,               /* -funroll-all-loops */
  OPT_funroll_loops = 956,                   /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 957,      /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 958,      /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 959,             /* -funsigned-bitfields */
  OPT_funsigned_char = 960,                  /* -funsigned-char */
  OPT_funswitch_loops = 961,                 /* -funswitch-loops */
  OPT_funwind_tables = 962,                  /* -funwind-tables */
  OPT_fuse_atomic_builtins = 963,            /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 964,                   /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 965,                 /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 966,      /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 967,          /* -fuse-divide-subroutine */
  OPT_fuse_ld_bfd = 968,                     /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 969,                    /* -fuse-ld=gold */
  OPT_fuse_linker_plugin = 970,              /* -fuse-linker-plugin */
  OPT_fvar_tracking = 971,                   /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 972,       /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 973,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 974,            /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 975, /* -fvariable-expansion-in-unroller */
  OPT_fvect_cost_model = 976,                /* -fvect-cost-model */
  OPT_fverbose_asm = 977,                    /* -fverbose-asm */
  /* OPT_fversion = 978, */                  /* -fversion */
  OPT_fvisibility_inlines_hidden = 979,      /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 980,           /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 981,                    /* -fvisibility= */
  OPT_fvpt = 982,                            /* -fvpt */
  /* OPT_fvtable_gc = 983, */                /* -fvtable-gc */
  /* OPT_fvtable_thunks = 984, */            /* -fvtable-thunks */
  OPT_fweak = 985,                           /* -fweak */
  OPT_fweb = 986,                            /* -fweb */
  OPT_fwhole_file = 987,                     /* -fwhole-file */
  OPT_fwhole_program = 988,                  /* -fwhole-program */
  OPT_fwide_exec_charset_ = 989,             /* -fwide-exec-charset= */
  OPT_fworking_directory = 990,              /* -fworking-directory */
  OPT_fwpa = 991,                            /* -fwpa */
  OPT_fwrapv = 992,                          /* -fwrapv */
  /* OPT_fxref = 993, */                     /* -fxref */
  /* OPT_fzee = 994, */                      /* -fzee */
  OPT_fzero_initialized_in_bss = 995,        /* -fzero-initialized-in-bss */
  OPT_fzero_link = 996,                      /* -fzero-link */
  OPT_g = 997,                               /* -g */
  OPT_gant = 998,                            /* -gant */
  OPT_gcoff = 999,                           /* -gcoff */
  OPT_gdwarf_ = 1000,                        /* -gdwarf- */
  OPT_gen_decls = 1001,                      /* -gen-decls */
  OPT_ggdb = 1002,                           /* -ggdb */
  OPT_gnat = 1003,                           /* -gnat */
  OPT_gnatO = 1004,                          /* -gnatO */
  OPT_gno_pubnames = 1005,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1006,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1007,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1008,               /* -gno-strict-dwarf */
  OPT_gpubnames = 1009,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1010,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1011,                   /* -gsplit-dwarf */
  OPT_gstabs = 1012,                         /* -gstabs */
  OPT_gstabs_ = 1013,                        /* -gstabs+ */
  OPT_gstrict_dwarf = 1014,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1015,                        /* -gtoggle */
  OPT_gvms = 1016,                           /* -gvms */
  OPT_gxcoff = 1017,                         /* -gxcoff */
  OPT_gxcoff_ = 1018,                        /* -gxcoff+ */
  OPT_h = 1019,                              /* -h */
  OPT_idirafter = 1020,                      /* -idirafter */
  OPT_imacros = 1021,                        /* -imacros */
  OPT_imultiarch = 1022,                     /* -imultiarch */
  OPT_imultilib = 1023,                      /* -imultilib */
  OPT_include = 1024,                        /* -include */
  OPT_iplugindir_ = 1025,                    /* -iplugindir= */
  OPT_iprefix = 1026,                        /* -iprefix */
  OPT_iquote = 1027,                         /* -iquote */
  OPT_isysroot = 1028,                       /* -isysroot */
  OPT_isystem = 1029,                        /* -isystem */
  OPT_iwithprefix = 1030,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1031,              /* -iwithprefixbefore */
  OPT_k8 = 1032,                             /* -k8 */
  OPT_l = 1033,                              /* -l */
  OPT_lang_asm = 1034,                       /* -lang-asm */
  OPT_mabi_ = 1035,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1036,             /* -mabort-on-noreturn */
  OPT_mapcs = 1037,                          /* -mapcs */
  OPT_mapcs_float = 1038,                    /* -mapcs-float */
  OPT_mapcs_frame = 1039,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1040,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1041,              /* -mapcs-stack-check */
  OPT_march_ = 1042,                         /* -march= */
  OPT_marm = 1043,                           /* -marm */
  OPT_mbig_endian = 1044,                    /* -mbig-endian */
  OPT_mcallee_super_interworking = 1045,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1046,     /* -mcaller-super-interworking */
  OPT_mcpu_ = 1047,                          /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 1048,            /* -mfix-cortex-m3-ldrd */
  OPT_mfloat_abi_ = 1049,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1050,                  /* -mfp16-format= */
  OPT_mfpu_ = 1051,                          /* -mfpu= */
  /* OPT_mhard_float = 1052, */              /* -mhard-float */
  OPT_mlittle_endian = 1053,                 /* -mlittle-endian */
  OPT_mlong_calls = 1054,                    /* -mlong-calls */
  OPT_mpic_register_ = 1055,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1056,            /* -mpoke-function-name */
  OPT_msched_prolog = 1057,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1058,               /* -msingle-pic-base */
  /* OPT_msoft_float = 1059, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1060,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1061,                         /* -mthumb */
  OPT_mthumb_interwork = 1062,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1063,                  /* -mtls-dialect= */
  OPT_mtp_ = 1064,                           /* -mtp= */
  OPT_mtpcs_frame = 1065,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1066,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1067,                         /* -mtune= */
  OPT_munaligned_access = 1068,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1069,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1070,      /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 1071,              /* -mword-relocations */
  OPT_mwords_little_endian = 1072,           /* -mwords-little-endian */
  OPT_n = 1073,                              /* -n */
  OPT_no_canonical_prefixes = 1074,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1075,              /* -no-integrated-cpp */
  OPT_nocpp = 1076,                          /* -nocpp */
  OPT_nodefaultlibs = 1077,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1078,                   /* -nostartfiles */
  OPT_nostdinc = 1079,                       /* -nostdinc */
  OPT_nostdinc__ = 1080,                     /* -nostdinc++ */
  OPT_nostdlib = 1081,                       /* -nostdlib */
  OPT_o = 1082,                              /* -o */
  OPT_p = 1083,                              /* -p */
  OPT_pass_exit_codes = 1084,                /* -pass-exit-codes */
  /* OPT_pedantic = 1085, */                 /* -pedantic */
  OPT_pedantic_errors = 1086,                /* -pedantic-errors */
  OPT_pg = 1087,                             /* -pg */
  OPT_pie = 1088,                            /* -pie */
  OPT_pipe = 1089,                           /* -pipe */
  OPT_print_file_name_ = 1090,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1091,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1092,          /* -print-multi-directory */
  OPT_print_multi_lib = 1093,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1094,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1095,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1096,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1097,               /* -print-prog-name= */
  OPT_print_search_dirs = 1098,              /* -print-search-dirs */
  OPT_print_sysroot = 1099,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1100,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1101,                          /* -quiet */
  OPT_r = 1102,                              /* -r */
  OPT_remap = 1103,                          /* -remap */
  OPT_s = 1104,                              /* -s */
  OPT_s_bc_abi = 1105,                       /* -s-bc-abi */
  OPT_save_temps = 1106,                     /* -save-temps */
  OPT_save_temps_ = 1107,                    /* -save-temps= */
  OPT_shared = 1108,                         /* -shared */
  OPT_shared_libgcc = 1109,                  /* -shared-libgcc */
  /* OPT_specs = 1110, */                    /* -specs */
  OPT_specs_ = 1111,                         /* -specs= */
  OPT_static = 1112,                         /* -static */
  OPT_static_libasan = 1113,                 /* -static-libasan */
  ...
  OPT_static_libtsan = 1119,                 /* -static-libtsan */
  /* OPT_std_c__03 = 1120, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1121, */                /* -std=c++0x */
  OPT_std_c__11 = 1122,                      /* -std=c++11 */
  OPT_std_c__1y = 1123,                      /* -std=c++1y */
  OPT_std_c__98 = 1124,                      /* -std=c++98 */
  OPT_std_c11 = 1125,                        /* -std=c11 */
  /* OPT_std_c1x = 1126, */                  /* -std=c1x */
  /* OPT_std_c89 = 1127, */                  /* -std=c89 */
  OPT_std_c90 = 1128,                        /* -std=c90 */
  OPT_std_c99 = 1129,                        /* -std=c99 */
  /* OPT_std_c9x = 1130, */                  /* -std=c9x */
  OPT_std_f2003 = 1131,                      /* -std=f2003 */
  OPT_std_f2008 = 1132,                      /* -std=f2008 */
  OPT_std_f2008ts = 1133,                    /* -std=f2008ts */
  OPT_std_f95 = 1134,                        /* -std=f95 */
  OPT_std_gnu = 1135,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1136, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1137, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1138,                    /* -std=gnu++11 */
  OPT_std_gnu__1y = 1139,                    /* -std=gnu++1y */
  OPT_std_gnu__98 = 1140,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1141,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1142, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1143, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1144,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1145,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1146, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1147, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1148,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1149, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1150, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1151, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1152,                     /* -std=legacy */
  OPT_symbolic = 1153,                       /* -symbolic */
  OPT_t = 1154,                              /* -t */
  OPT_time = 1155,                           /* -time */
  OPT_time_ = 1156,                          /* -time= */
